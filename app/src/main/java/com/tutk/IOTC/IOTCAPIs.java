...
------------|------------------|---------------|-------------------
3.1.10.5    |Terry Liu         |2018-05-20     |- Mark IOTC_Device_LoginNB, IOTC_Get_Device_Status, IOTC_Accept as deprecated
3.1.10.5    |Terry Liu         |2018-05-20     |- Mark IOTC_Connect_ByUIDNB, IOTC_Connect_ByUID_ParallelNB, IOTC_Session_Write_Reliable_NB as deprecated
3.1.10.5    |Terry Liu         |2018-05-20     |- Mark IOTC_Session_Write_Reliable_NB_Abort, IOTC_Reliable_All_MSG_Is_Sent, IOTC_Initialize as deprecated
3.1.10.5    |Terry Liu         |2018-05-20     |- Mark IOTC_Setup_DetectNetwork_Timeout, IOTC_Setup_ErrorUpload, IOTC_ConnModeChange_CallBack as deprecated
3.1.10.5    |Terry Liu         |2018-05-20     |- Mark IOTC_Lan_Search, IOTC_Lan_Search2 as deprecated
3.1.10.6	|Ethan Tsai	       |2019-02-11     |- Mark IOTC_Lan_Search2_Ex as deprecated
3.1.10.6	|Ethan Tsai	       |2019-02-11	   |- Mark IOTC_Connect_ByUID as deprecated
3.1.10.6    |Ethan Tsai		   |2019-02-11	   |- Mark IOTC_Session_Check, IOTC_Session_Check_ByCallBackFn as deprecated
3.1.10.6    |Ethan Tsai        |2019-02-11     |- Mark IOTC_Session_Read_Check_Lost as deprecated
 */
...
public class IOTCAPIs {
	...
	* Please see IOTCConnectionMode for possible modes. */
	...
	@Deprecated public native static int  IOTC_Initialize(int UDPPort, String P2PHostNamePrimary,
	...
	public native static int  IOTC_Device_LoginEx(String UID, St_DeviceLoginInput Device_input);
	...
	@Deprecated public native static int  IOTC_Connect_ByUID(String UID);
	...
	@Deprecated public native static int  IOTC_Session_Check(int SID, St_SInfo s_Info);
	...
	@Deprecated public native static st_LanSearchInfo[]  IOTC_Lan_Search (int[] arrNum, int nWaitTimeMs);
	@Deprecated public native static st_LanSearchInfo2[] IOTC_Lan_Search2(int[] arrNum, int nWaitTimeMs);
	@Deprecated public native static st_LanSearchInfo2[] IOTC_Lan_Search2_Ex(int[] arrNum, int nWaitTimeMs, int nSendIntervalMs);
    ...
    @Deprecated public native static void IOTC_Set_Log_Path(String path, int maxSize);
    public native static int IOTC_Set_Log_Attr(St_LogAttr logAttr);
	...
	@Deprecated public native static int  IOTC_Session_Check_ByCallBackFn(int SID, Object obj);  	//Callback method, pass object itself.
	public native static int  IOTC_Set_Partial_Encryption(int SID, int bPartialEncryption);
	@Deprecated public native static int  IOTC_Session_Read_Check_Lost(int SID, byte[] Buf, int Max_size,int Timeout_ms, int[] PacketSN, int[] FlagLost, int ChID);
	...
	@Deprecated public native static void IOTC_Setup_DetectNetwork_Timeout(int Timeout_ms);
	public native static void IOTC_Setup_Session_Alive_Timeout(int Timeout_sec);
	@Deprecated public native static void IOTC_Setup_ErrorUpload(int bEnable);
	@Deprecated public native static int  IOTC_Session_Write_Reliable(int SID, byte[] Buf, int Size, int ChID, int nTimeout);
	@Deprecated public native static int  IOTC_Session_Write_Reliable_Abort(int SID, int ChID);
	...
	@Deprecated public native static void IOTC_ConnModeChange_CallBack(Object obj);
	@Deprecated public native static int IOTC_Device_LoginNB(String cszUID, String cszDeviceName, String cszDevicePWD, byte[] userData, Object obj);
	@Deprecated public native static int IOTC_Get_Device_Status(st_DeviceStInfo pDevStInfo);
	@Deprecated public native static int IOTC_Accept(int[] SID);
	@Deprecated public native static int IOTC_Connect_ByUIDNB(String cszUID, byte[] userData, Object obj);
	@Deprecated public native static int IOTC_Connect_ByUID_ParallelNB(String cszUID, int SID, byte[] userData, Object obj);
	...
	public native static int IOTC_Device_Update_Authkey(String new_authkey);
	public native static int IOTC_Set_Master_Region(Region region);
	/*DebugTool */
