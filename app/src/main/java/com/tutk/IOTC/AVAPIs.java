...
public class AVAPIs {
    ...
    @Deprecated public native static int avServStart(int nSID, String viewAcc, String viewPwd, int timeout_sec, int servType, int ChID);
	...
	@Deprecated public native static int  avRecvFrameData(int avIndex,byte[] buf, int bufMaxSize,byte[] pFrmInfo, int FrmInfoMaxSize, int[] pFrmNo);
